 ...
 * 
 */
@WebServiceClient(name = "UtsWsContentControllerImplService", targetNamespace = "http://webservice.uts.umls.nlm.nih.gov/", wsdlLocation = "https://uts.nlm.nih.gov:443/services/nwsContent?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://uts.nlm.nih.gov:443/services/nwsContent?wsdl");
